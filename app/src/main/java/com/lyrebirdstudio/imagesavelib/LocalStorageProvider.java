...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(String[] projection) throws FileNotFoundException {
        ...
        if (TextUtils.equals(Environment.getExternalStorageState(), "mounted")) {
            ...
            row.add("icon", Integer.valueOf(R.drawable.ic_launcher));
        ...
        if (TextUtils.equals(storageState, "mounted") || TextUtils.equals(storageState, "mounted_ro")) {
            ...
            row.add("icon", Integer.valueOf(R.drawable.image_save_save));
    ...
    public AssetFileDescriptor openDocumentThumbnail(String documentId, Point sizeHint, CancellationSignal signal) throws FileNotFoundException {
        ...
        try {
            ...
            try {
                ...
                out = out2;
                try {
                    Log.e(LocalStorageProvider.class.getSimpleName(), "Error writing thumbnail", e3);
                    if (out != null) {
                        return null;
                    }
                    try {
